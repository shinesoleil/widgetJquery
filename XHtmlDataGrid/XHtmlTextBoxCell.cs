...
{
	class XHtmlTextBoxCell : TextBox, IXHtmlDataGridCell
	{
		...
		private readonly XHtmlTextBoxColumn column;
		private string text, rowText;


		#region Constructeur
		static XHtmlTextBoxCell()
		{
		...
		/// </summary>
		public XHtmlTextBoxCell(XHtmlGenericColumn column)   // !!!!!!!!!DataGridColumn
		{
		...
		public void SetStyle()
		{
			...
			ToolTip = (Presentation.ToolTipFlag) ? Presentation.ToolTip : column.ToolTip;
			TextAlignment = (Presentation.TextAlignmentFlag) ? Presentation.TextAlignment : column.TextAlignment;
